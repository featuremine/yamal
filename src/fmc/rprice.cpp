...
void fmc_rprice_from_raw(fmc_rprice_t *dest, int64_t src) {
  dest->value = src;
}
...
bool fmc_rprice_less(const fmc_rprice_t *lhs,
...
bool fmc_rprice_greater(const fmc_rprice_t *lhs,
                               const fmc_rprice_t *rhs) {
  return lhs->value > rhs->value;
}
...
bool fmc_rprice_equal(const fmc_rprice_t *lhs,
                             const fmc_rprice_t *rhs) {
  return lhs->value == rhs->value;
}

void fmc_rprice_div(fmc_rprice_t *res,
...
void fmc_rprice_int_div(fmc_rprice_t *res,
                               const fmc_rprice_t *lhs, int64_t rhs) {
  res->value = lhs->value / rhs;
}
void fmc_rprice_add(fmc_rprice_t *res,
                              const fmc_rprice_t *lhs,
                              const fmc_rprice_t *rhs) {
  res->value = lhs->value + rhs->value;
}
void fmc_rprice_inc(fmc_rprice_t *lhs,
                           const fmc_rprice_t *rhs) {
  lhs->value += rhs->value;
}
void fmc_rprice_sub(fmc_rprice_t *res,
                           const fmc_rprice_t *lhs,
                           const fmc_rprice_t *rhs) {
  res->value = lhs->value - rhs->value;
}
void fmc_rprice_dec(fmc_rprice_t *lhs,
                           const fmc_rprice_t *rhs) {
  lhs->value -= rhs->value;
}
void fmc_rprice_mul(fmc_rprice_t *res,
                           const fmc_rprice_t *lhs,
                           const fmc_rprice_t *rhs) {
...
void fmc_rprice_max(fmc_rprice_t *res) {
  res->value = FMC_RPRICE_MAX.value;
}
void fmc_rprice_min(fmc_rprice_t *res) {
  res->value = FMC_RPRICE_MIN.value;
}

void fmc_rprice_abs(fmc_rprice_t *res,
                           const fmc_rprice_t *val) {
  res->value = llabs(val->value);
}
void fmc_rprice_negate(fmc_rprice_t *res,
                              const fmc_rprice_t *val) {
  res->value = (-val->value);
}
