...
#define FXPT128_DEBUG_SET(x)                                                   \
  fmc_fxpt128_to_string(FXPT128_last, sizeof(FXPT128_last), x)
#else
#define FXPT128_DEBUG_SET(x)
#endif
...
const struct fmc_fxpt128_format_t FXPT128_default_format = {
    fmc_fxpt128_to_string_sign_default, 0, -1, 0, 0, 0};

const struct fmc_fxpt128_t FXPT128_min = {0,
                                          FXPT128_LIT_U64(0x8000000000000000)};
const struct fmc_fxpt128_t FXPT128_max = {FXPT128_LIT_U64(0xffffffffffffffff),
                                          FXPT128_LIT_U64(0x7fffffffffffffff)};
...
// 64/32->32
static FXPT128_U32 fmc_fxpt128__udiv64(FXPT128_U32 nlo, FXPT128_U32 nhi,
                                       FXPT128_U32 d, FXPT128_U32 *rem) {
  ...
  FXPT128_U32 q, r;
  __asm("divl %4" : "=a"(q), "=d"(r) : "a"(nlo), "d"(nhi), "X"(d));
  *rem = r;
  return q;
#else
...
static void fmc_fxpt128__neg(struct fmc_fxpt128_t *dst,
...
// 64*64->128
static void fmc_fxpt128__umul128(struct fmc_fxpt128_t *dst, FXPT128_U64 a,
                                 FXPT128_U64 b) {
...

  {
    ...
    carry = ((FXPT128_U64)(FXPT128_U32)p1 + (FXPT128_U64)(FXPT128_U32)p2 +
             (p0 >> 32)) >>
            32;
...
// 128/64->64
#if defined(_M_X64) && (_MSC_VER < 1920) && !defined(FXPT128_STDC_ONLY) &&     \
    !defined(__MINGW32__)
// MSVC x64 provides neither inline assembly nor (pre-2019) a div intrinsic, so
// we do fake "inline assembly" to avoid long division or outline assembly.
#pragma code_seg(".text")
__declspec(allocate(".text") align(16)) static const
    unsigned char fmc_fxpt128__udiv128Code[] = {
        0x48, 0x8B, 0xC1, // mov  rax, rcx
        0x49, 0xF7, 0xF0, // div  rax, r8
        0x49, 0x89, 0x11, // mov  qword ptr [r9], rdx
        0xC3              // ret
};
typedef FXPT128_U64 (*fmc_fxpt128__udiv128Proc)(FXPT128_U64 nlo,
                                                FXPT128_U64 nhi, FXPT128_U64 d,
                                                FXPT128_U64 *rem);
static const fmc_fxpt128__udiv128Proc fmc_fxpt128__udiv128 =
    (fmc_fxpt128__udiv128Proc)(void *)fmc_fxpt128__udiv128Code;
#else
static FXPT128_U64 fmc_fxpt128__udiv128(FXPT128_U64 nlo, FXPT128_U64 nhi,
                                        FXPT128_U64 d, FXPT128_U64 *rem) {
...
refine1:
  ...
  tmp = ((FXPT128_U64)n2 << 32) + n1 -
        (fmc_fxpt128__umul64(q1, d0) + (fmc_fxpt128__umul64(q1, d1) << 32));
...
refine0:
  ...
  tmp = ((FXPT128_U64)n1 << 32) + n0 -
        (fmc_fxpt128__umul64(q0, d0) + (fmc_fxpt128__umul64(q0, d1) << 32));
...
static int fmc_fxpt128__ucmp(const struct fmc_fxpt128_t *a,
...
static void fmc_fxpt128__umul(struct fmc_fxpt128_t *dst,
...
static int fmc_fxpt128__norm(struct fmc_fxpt128_t *n, struct fmc_fxpt128_t *d,
                             FXPT128_U64 *n2) {
  FXPT128_U64 d0, d1;
  FXPT128_U64 n0, n1;
  int shift;
...
static void fmc_fxpt128__udiv(struct fmc_fxpt128_t *quotient,
                              const struct fmc_fxpt128_t *dividend,
                              const struct fmc_fxpt128_t *divisor) {
...
static FXPT128_U64 fmc_fxpt128__umod(struct fmc_fxpt128_t *n,
                                     struct fmc_fxpt128_t *d) {
  FXPT128_U64 d0, d1;
...
static int fmc_fxpt128__format(char *dst, size_t dstsize,
                               const struct fmc_fxpt128_t *v,
                               const struct fmc_fxpt128_format_t *format) {
  char buf[128];
  struct fmc_fxpt128_t tmp;
  FXPT128_U64 whole;
...
void fmc_fxpt128_from_string(struct fmc_fxpt128_t *dst, const char *s,
                             const char **endptr) {
...
unsigned fmc_fxpt128_floorlog2(const struct fmc_fxpt128_t *v) {
  ...
  FXPT128_SET2(&tmp, v->lo, v->hi);
  return (!tmp.hi) * FMC_FLOORLOG2(tmp.lo) +
         (!!tmp.hi) * (FMC_FLOORLOG2(tmp.hi) + 64);
}
...
int fmc_fxpt128_to_string_opt(char *dst, size_t dstsize,
                              const struct fmc_fxpt128_t *v,
                              const struct fmc_fxpt128_format_t *opt) {
  return fmc_fxpt128__format(dst, dstsize, v, opt);
}

int fmc_fxpt128_to_stringf(char *dst, size_t dstsize, const char *format,
                           const struct fmc_fxpt128_t *v) {
...
int fmc_fxpt128_to_string(char *dst, size_t dstsize,
                          const struct fmc_fxpt128_t *v) {
  return fmc_fxpt128__format(dst, dstsize, v, &FXPT128_default_format);
}

void fmc_fxpt128_copy(struct fmc_fxpt128_t *dst,
                      const struct fmc_fxpt128_t *src) {
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(src != NULL);
  dst->lo = src->lo;
...
void fmc_fxpt128_nabs(struct fmc_fxpt128_t *dst,
                      const struct fmc_fxpt128_t *v) {
  struct fmc_fxpt128_t sign, inv;
...
void fmc_fxpt128_not(struct fmc_fxpt128_t *dst,
                     const struct fmc_fxpt128_t *src) {
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(src != NULL);
...
void fmc_fxpt128_or(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                    const struct fmc_fxpt128_t *b) {
  FXPT128_ASSERT(dst != NULL);
...
void fmc_fxpt128_and(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                     const struct fmc_fxpt128_t *b) {
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(a != NULL);
  FXPT128_ASSERT(b != NULL);
...
void fmc_fxpt128_xor(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                     const struct fmc_fxpt128_t *b) {
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(a != NULL);
  FXPT128_ASSERT(b != NULL);
...
void fmc_fxpt128_shl(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *src,
                     int amount) {
  FXPT128_U64 r[4];
...
void fmc_fxpt128_shr(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *src,
                     int amount) {
  FXPT128_U64 r[4];
...
void fmc_fxpt128_sar(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *src,
                     int amount) {
  FXPT128_U64 r[4];
...
void fmc_fxpt128_add(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                     const struct fmc_fxpt128_t *b) {
  unsigned char carry = 0;
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(a != NULL);
...
void fmc_fxpt128_sub(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                     const struct fmc_fxpt128_t *b) {
...
void fmc_fxpt128_mul(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                     const struct fmc_fxpt128_t *b) {
  int sign = 0;
...
void fmc_fxpt128_div(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                     const struct fmc_fxpt128_t *b) {
  int sign = 0;
...
void fmc_fxpt128_mod(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                     const struct fmc_fxpt128_t *b) {
  int sign = 0;
  struct fmc_fxpt128_t tn, td, tq;
...
void fmc_fxpt128_rsqrt(struct fmc_fxpt128_t *dst,
                       const struct fmc_fxpt128_t *v) {
  static const struct fmc_fxpt128_t threeHalves = {
      FXPT128_LIT_U64(0x8000000000000000), 1};
...
void fmc_fxpt128_sqrt(struct fmc_fxpt128_t *dst,
                      const struct fmc_fxpt128_t *v) {
  struct fmc_fxpt128_t x, est;
  int i;
...
int fmc_fxpt128_cmp(const struct fmc_fxpt128_t *a,
                    const struct fmc_fxpt128_t *b) {
  FXPT128_ASSERT(a != NULL);
  FXPT128_ASSERT(b != NULL);
...
void fmc_fxpt128_min(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                     const struct fmc_fxpt128_t *b) {
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(a != NULL);
  FXPT128_ASSERT(b != NULL);
...
void fmc_fxpt128_max(struct fmc_fxpt128_t *dst, const struct fmc_fxpt128_t *a,
                     const struct fmc_fxpt128_t *b) {
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(a != NULL);
  FXPT128_ASSERT(b != NULL);
...
void fmc_fxpt128_floor(struct fmc_fxpt128_t *dst,
                       const struct fmc_fxpt128_t *v) {
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(v != NULL);
...
void fmc_fxpt128_ceil(struct fmc_fxpt128_t *dst,
                      const struct fmc_fxpt128_t *v) {
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(v != NULL);
...
void fmc_fxpt128_round(struct fmc_fxpt128_t *dst,
                       const struct fmc_fxpt128_t *v) {
  FXPT128_ASSERT(dst != NULL);
  FXPT128_ASSERT(v != NULL);

  dst->hi = v->hi + (v->lo >= FXPT128_LIT_U64(0x8000000000000000) +
                                  (FXPT128_U64)((FXPT128_S64)v->hi < 0));
  dst->lo = 0;
  FXPT128_DEBUG_SET(dst);
}
