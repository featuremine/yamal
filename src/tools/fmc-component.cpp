...
struct deleter_t {
  void operator()(struct fmc_component_module *ptr) { fmc_component_module_del(ptr); }
...
int main(int argc, char **argv) {
  ...
  TCLAP::UnlabeledValueArg<std::string> moduleArg("module", "Module name", true, "module", "module");
  cmd.add(moduleArg);

  TCLAP::UnlabeledValueArg<std::string> componentArg("component", "Component name", true, "component", "component");
