...
char *ytp_sequence_shared_reserve(shared_sequence *sh_seq, size_t sz,
                                  fmc_error_t **error) {
  ytp_sequence_t *seq = ytp_sequence_shared_get((ytp_sequence_shared_t *)sh_seq);
...
void ytp_sequence_shared_ch_cb_rm(shared_sequence *sh_seq, ytp_sequence_ch_cb_t cb,
                               void *closure, fmc_error_t **error) {
  ytp_sequence_t *seq = ytp_sequence_shared_get((ytp_sequence_shared_t *)sh_seq);
...
ytp_iterator_t ytp_sequence_shared_end(shared_sequence *sh_seq, fmc_error_t **error) {
  ytp_sequence_t *seq = ytp_sequence_shared_get((ytp_sequence_shared_t *)sh_seq);
...
void ytp_sequence_shared_set_it(shared_sequence *sh_seq,
  ...
  ytp_sequence_t *seq = ytp_sequence_shared_get((ytp_sequence_shared_t *)sh_seq);
  return ytp_sequence_set_it(seq, iterator);  
}
...
size_t ytp_sequence_shared_tell(shared_sequence *sh_seq, ytp_iterator_t iterator,
                                  fmc_error_t **error) {
  ytp_sequence_t *seq = ytp_sequence_shared_get((ytp_sequence_shared_t *)sh_seq);
...
static struct ytp_sequence_api_v1 api_v1 {
  ytp_sequence_shared_reserve,
  ytp_sequence_shared_commit,
  ytp_sequence_shared_sub,
  ytp_sequence_shared_dir,
  ytp_sequence_shared_ch_name,
  ytp_sequence_shared_ch_decl,
  ytp_sequence_shared_ch_cb,
  ytp_sequence_shared_ch_cb_rm,
  ytp_sequence_shared_peer_name,
  ytp_sequence_shared_peer_decl,
  ytp_sequence_shared_peer_cb,
  ytp_sequence_shared_peer_cb_rm,
  ytp_sequence_shared_prfx_cb,
  ytp_sequence_shared_prfx_cb_rm,
  ytp_sequence_shared_indx_cb,
  ytp_sequence_shared_indx_cb_rm,
  ytp_sequence_shared_poll,
  ytp_sequence_shared_term,
  ytp_sequence_shared_end,
  ytp_sequence_shared_cur,
  ytp_sequence_shared_get_it,
  ytp_sequence_shared_set_it,
  ytp_sequence_shared_seek,
  ytp_sequence_shared_tell,
  (sharedseqinc)ytp_sequence_shared_inc,
  (sharedseqdec)ytp_sequence_shared_dec
};
