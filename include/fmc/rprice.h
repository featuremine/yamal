...
inline void fmc_rprice_from_ratio(fmc_rprice_t *dest, int64_t num,
                                  int64_t denum) {
...
inline bool fmc_rprice_less(const fmc_rprice_t *lhs, const fmc_rprice_t *rhs) {
...
inline bool fmc_rprice_equal(const fmc_rprice_t *lhs, const fmc_rprice_t *rhs) {
  return lhs->value == rhs->value;
}

inline void fmc_rprice_div(fmc_rprice_t *res, const fmc_rprice_t *lhs,
                           const fmc_rprice_t *rhs) {
  res->value = (lhs->value / rhs->value) * RPRICE_FRACTION;
}
inline void fmc_rprice_flt_div(double *res, const fmc_rprice_t *lhs,
                               const fmc_rprice_t *rhs) {
  *res = (double)lhs->value / (double)rhs->value;
}
inline void fmc_rprice_int_div(fmc_rprice_t *res, const fmc_rprice_t *lhs,
                               int64_t rhs) {
  res->value = lhs->value / rhs;
}
inline void fmc_rprice_add(fmc_rprice_t *res, const fmc_rprice_t *lhs,
                           const fmc_rprice_t *rhs) {
  res->value = lhs->value + rhs->value;
}
inline void fmc_rprice_inc(fmc_rprice_t *lhs, const fmc_rprice_t *rhs) {
  lhs->value += rhs->value;
}
inline void fmc_rprice_sub(fmc_rprice_t *res, const fmc_rprice_t *lhs,
                           const fmc_rprice_t *rhs) {
  res->value = lhs->value - rhs->value;
}
inline void fmc_rprice_dec(fmc_rprice_t *lhs, const fmc_rprice_t *rhs) {
  lhs->value -= rhs->value;
}
inline void fmc_rprice_mul(fmc_rprice_t *res, const fmc_rprice_t *lhs,
                           const fmc_rprice_t *rhs) {
...
inline void fmc_rprice_abs(fmc_rprice_t *res, const fmc_rprice_t *val) {
  res->value = llabs(val->value);
}
inline void fmc_rprice_negate(fmc_rprice_t *res, const fmc_rprice_t *val) {
  res->value = (-val->value);
}
