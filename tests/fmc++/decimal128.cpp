...
TEST(decimal128, comparison) {
  fmc_decimal128_t a, b, c;
  fmc_decimal128_from_str(&a, "2");
  fmc_decimal128_from_str(&b, "2.5");
  fmc_decimal128_from_str(&c, "3");
...
TEST(decimal128, identity_extreme) {
  ...
  auto to_str = [&](double number) {
    ...
    fmc_decimal128_from_str(&a, number_str);
    fmc_decimal128_from_double(&b, number);
...
TEST(decimal128, exp63_check) {
  ...
  fmc_decimal128_from_str(&table[0], "1");
  fmc_decimal128_from_str(&table[1], "9223372036854775808");
